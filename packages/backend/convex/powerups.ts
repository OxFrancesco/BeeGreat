...
export const POWERUP_CATALOG = [
  ...
  },
  {
    ...
    description:
      'Gives your Bee a secure smart wallet and DeFi smarts: balances, transfers, Aerodrome pools, swaps, liquidity, and rewards. Anything that moves funds waits for your confirmation in BeeGreat or iMessage, and you can link your own wallet for plans you sign yourself.',
  },
  {
    id: 'google-health',
    name: 'Google Health',

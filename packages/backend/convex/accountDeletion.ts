...
const STAGE_REMOVERS = {
  ...
  raindropConnections: removesBatch((ctx, ownerKey) => ctx.db.query('raindropConnections').withIndex('by_ownerKey', q => q.eq('ownerKey', ownerKey))),
  raindropSessions: removesBatch((ctx, ownerKey) => ctx.db.query('raindropSessions').withIndex('by_ownerKey', q => q.eq('ownerKey', ownerKey))),
  raindropImports: removesBatch((ctx, ownerKey) => ctx.db.query('raindropImports').withIndex('by_ownerKey_and_raindropId', q => q.eq('ownerKey', ownerKey))),

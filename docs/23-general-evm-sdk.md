...
`packages/evm` contains the `@beegreat/evm` Effect SDK, JSON CLI, OpenTUI application and MCP server. [Package documentation](../packages/evm/README.md) covers commands, execution, Socket, recovery and configuration.

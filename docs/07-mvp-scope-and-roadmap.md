...
The first-focus baseline is implemented under FRA-461. Work has moved to the FRA-463 focus economy: server-authoritative Brain Fatigue, Genius State, Royal Jelly, Goal lifecycle settlement, starter Achievements, and temporary Boosters. The TanStack web twin now has feature parity with the mobile product surface: Bee and voice, shared conversations, Goals/Projects/Tasks, Hive, ChatGPT, power-ups, Google Health, and settings all use the same Clerk, Convex, and Flue services. Automated verification remains part of implementation; user testing begins in the final phase. See [10 – Crosswalk](10-linear-docs-implementation-crosswalk.md) and the [web parity audit](../apps/web/PARITY.md).
...
| 2026-07-07 | A bee design per power-up                                      | Founder request                       | Added as planned feature (Phase 2)                                                                                                              | Power-up system now exists (Web3 first); reuses the FAL bee pipeline so each power-up feels distinct                                                                                                                      |
...
| 2026-07-13 | TanStack web parity                                            | Founder direction                     | **Match the complete mobile product surface using its existing services**                                                                       | Bee, voice, conversation identity, generated UI, Goals/Projects/Tasks, Hive, auth connections, power-ups, health, and settings now share Clerk, Convex, and Flue across devices                                           |

...
- **Name**: Bee Great (pun: "Bee the best version of yourself")
- **Theme**: bees — collaborative, hard-working; hive/honeycomb/honey as core metaphors
- Unique user handles are a must (for the Bee Card / social layer)

## Inspirations

- **Dayflow** — automatic work journal & AI time tracker for Mac
- **Rize.io** — automatic time tracking benchmark; we need feature parity on desktop tracking

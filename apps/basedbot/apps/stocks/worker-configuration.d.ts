/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1c24fd334bb71c965483a6f0a0dd1d39)
// Runtime types generated with workerd@1.20260911.1 2026-09-14 nodejs_compat
interface __BaseEnv_Env {
	CLERK_SECRET_KEY: string;
	VITE_CLERK_PUBLISHABLE_KEY: string;
	AERO: Fetcher /* basedbot-aero */;
	BASED_BOT: Service /* entrypoint StocksGateway from basedbot */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLERK_SECRET_KEY" | "VITE_CLERK_PUBLISHABLE_KEY">> {}
}

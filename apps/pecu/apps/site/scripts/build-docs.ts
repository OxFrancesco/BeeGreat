...
const output = resolve(import.meta.dir, "../public/un-aerosdk/docs");
await mkdir(output, { recursive: true });
await Bun.write(resolve(output, "index.html"), `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="color-scheme" content="light"><meta name="darkreader-lock"><title>Aero CLI documentation</title><link rel="icon" href="/un-aerosdk/favicon.svg"><link rel="canonical" href="https://pecu.app/un-aerosdk/docs"><style>
...
</style></head><body><header><a class="logo" href="/un-aerosdk">aero</a><a href="/stocks">Stocks</a><a href="/un-aerosdk">CLI</a><a aria-current="page" href="/un-aerosdk/docs">Docs</a></header><main><aside aria-label="On this page">${headings.map(h => `<a href="#${h.id}">${escape(h.text)}</a>`).join("")}</aside><article>${content}</article></main></body></html>`);

...
import { planSpecimens, transactionSpecimens } from "./transaction-specimens";
import { pnlSpecimen } from "./pnl-specimen";
import { safeSpecimen } from "./safe-specimen";
import { linkedWalletSpecimen } from "./linked-wallet-specimen";
import { transferSpecimen } from "./transfer-specimen";
...
const aeroCss = await read(resolve(pecu, "theme/aero.css"));
const homeTokens = tokens(themeCss, ".pecu-theme");
const materialTokens = tokens(clayCss, ".pecu-theme");
const aeroTokens = tokens(aeroCss, ".pecu-theme");
const palette = (
  items: typeof homeTokens,
  names = [
    "--background",
    "--foreground",
    "--primary",
...
await Promise.all([
  ...
  Bun.write(resolve(site, "public/pecu-assets/aero.css"), aeroCss),

...
The thread sidebar keeps page navigation below the thread list. On narrow screens, the Threads dialog provides the same links. The conversation hides the scrollbar while preserving scrolling and the jump-to-latest button.

/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7b9e11144fb891dc848712346f1022a1)
// Runtime types generated with workerd@1.20260828.1 2026-08-29 nodejs_compat
interface __BaseEnv_Env {
	INFERENCE: DurableObjectNamespace<import("./src/cloudflare/user-inference").UserInference>;
	BASE_RPC_URL: "https://base-mainnet.g.alchemy.com/public";
	...
	CHAT_PEER_USER_IDS: "1319617668186542087";
	CHAT_BOT_USER_ID: "2086819052069007360";
	WHOP_API_URL: "https://api.whop.com/api/v1";
	WHOP_API_VERSION_DATE: "2026-09-13";
	DEPOSIT_RELAY_MAX_USD: "500";
	DEPOSIT_RELAY_DAILY_MAX_USD: "2000";
	PECU: DurableObjectNamespace<import("./src/cloudflare/worker").BasedBotDurableObject>;
	AERO: Fetcher /* basedbot-aero */;
	CODEX: Fetcher /* basedbot-codex */;
	EVM: Fetcher /* basedbot-evm */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/cloudflare/worker");
		durableNamespaces: "BasedBotDurableObject" | "UserInference";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BASE_RPC_URL" | "ENABLE_MAINNET_EXECUTION" | "XCHAT_POLLING_ENABLED" | "X_WEBHOOK_URL" | "POLL_INTERVAL_MS" | "QUOTE_TTL_SECONDS" | "MAX_SLIPPAGE_BPS" | "CHAT_PEER_USER_IDS" | "CHAT_BOT_USER_ID" | "WHOP_API_URL" | "WHOP_API_VERSION_DATE" | "DEPOSIT_RELAY_MAX_USD" | "DEPOSIT_RELAY_DAILY_MAX_USD">> {}
}

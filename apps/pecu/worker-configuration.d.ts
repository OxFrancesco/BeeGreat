...
interface __BaseEnv_Env {
	...
	PECU: DurableObjectNamespace<import("./src/cloudflare/worker").PecuDurableObject>;
	AERO: Fetcher /* pecu-aero */;
	CODEX: Fetcher /* pecu-codex */;
	EVM: Fetcher /* pecu-evm */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/cloudflare/worker");
		durableNamespaces: "PecuDurableObject";
	}
